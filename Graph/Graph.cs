...
namespace Graph
{
    public class PublicationGraph : IGraph<Publication>
    {
        private List<IVertex<Publication>> Vertices;
        private IDictionary<int, List<IEdge<Publication>>> Edges;
        public PublicationGraph()
        {
            Vertices = new List<IVertex<Publication>>();
            Edges = new Dictionary<int, List<IEdge<Publication>>>();
        }
        public bool AddVertex(IVertex<Publication> vertex)
        {
            ...
            Vertices.Add(vertex);
            Edges.Add(vertex.Id, new List<IEdge<Publication>>());
            return true;
        }
        ...
        public IEnumerable<IVertex<Publication>> GetAdj(int vertexId)
        {
        ...
        public static void Main(string[] args)
        {
            ...
            g.AddVertex(new Vertex(0, new Publication { Title = "Publication 0" }));
            g.AddVertex(new Vertex(1, new Publication { Title = "Publication 1" }));
            g.AddVertex(new Vertex(2, new Publication { Title = "Publication 2" }));
            g.AddVertex(new Vertex(3, new Publication { Title = "Publication 3" }));
            g.AddVertex(new Vertex(4, new Publication { Title = "Publication 4" }));
            g.AddVertex(new Vertex(5, new Publication { Title = "Publication 5" }));
            g.AddVertex(new Vertex(6, new Publication { Title = "Publication 6" }));
            g.AddVertex(new Vertex(7, new Publication { Title = "Publication 7" }));
            g.AddVertex(new Vertex(8, new Publication { Title = "Publication 8" }));
            g.AddVertex(new Vertex(9, new Publication { Title = "Publication 9" }));
            g.AddVertex(new Vertex(10, new Publication { Title = "Publication 10" }));
            g.AddVertex(new Vertex(11, new Publication { Title = "Publication 11" }));
            g.AddEdge(0, 1);
            g.AddEdge(0, 2);
            g.AddEdge(1, 3);
            g.AddEdge(3, 5);
