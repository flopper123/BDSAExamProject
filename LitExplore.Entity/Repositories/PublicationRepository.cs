...
{  
    ...
    public async Task<PublicationDetails> GetDetails(PublicationTitle title)
    {
    ...
    public async Task<PublicationDetails?> CreateAsync(PublicationDetails publication) // Should never return null..
    {
    ...
    public async Task<PublicationDetails?> ReadAsync(string pubTitle) // Not so async HMM??
    {
        var pub =
        ...
        throw new NotImplementedException(); //return await pub.FirstOrDefaultAsync(); // should return 404--or-equivalent if not found.
    }

    // Read all publications async
    public async Task<IReadOnlyCollection<PublicationDetails>> ReadAsync() // Not so async HMM??
    {
        throw new NotImplementedException();
    ...
    */
    ...
    public async Task<Status> UpdateAsync(PublicationDetails publication)
    { throw new NotImplementedException(); }
    ...
    public async Task<Status> DeleteAsync(string pubTitle) // Should maybe be Object instead PublicationTitle.
    {
        throw new NotImplementedException();
    }
